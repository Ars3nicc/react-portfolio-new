          ...
          <section className="py-6 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <article className="text-gray-500">
                ...
                aeronautical-based systems. Constructed UI/UX architecture using
                Javascript and PHP frameworks. Collaborated with executive
                members including contributing as head of major projects of CAAP
          ...
          <section className="py-6 mt-5 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <article className="text-gray-500">
                ...
                within the agency's IT infrastructure. Led and managed end-user
                projects for both national and international agencies,
                significantly enhancing the agency's IT systems.
              </article>
            </div>
          </section>
          <section className="py-6 mt-5 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <article className="text-gray-500">
                ...
                user-friendly interfaces using HTML, CSS, and JavaScript, while
                collaborating with the UX team for seamless design.
              </article>
            </div>
          </section>
          <section className="py-6 mt-5 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <article className="text-gray-500">
                ...
                databases for accurate and timely data collection and reporting.
                Assisted in creating insightful reports and presentations for
