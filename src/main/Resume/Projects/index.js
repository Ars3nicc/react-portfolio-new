    ...
    <div>
      ...
      <div className="pt-16 grid grid-cols-1 md:grid-cols-3 gap-16 justify-evenly">
        ...
        <div class="group max-w-lg bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 transition-transform transform hover:scale-105 hover:shadow-lg hover:bg-gray-100 dark:hover:bg-gray-700">
          ...
          <div class="p-4">
            <h5 class="mb-2 text-2xl md:text-3xl font-bold tracking-tight ">
              Certinize: Blockchain e-Certificate Issuance and Verification
            </h5>
            <p class="mt-6 mb-3 font-normal text-gray-700 dark:text-gray-400">
              A secure platform leveraging blockchain technology for the
              issuance and verification of electronic certificates. Designed to
              streamline processes, it provides accurate, tamper-proof
              certifications and verification tools, supporting transparency and
              trust for organizations and individuals.
            </p>
            <div className="pt-4">
              <a
                href="https://certinize-app-mui.vercel.app"
                class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Visit Website
                <svg
